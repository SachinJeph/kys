<%@ Page Title="" Language="C#" MasterPageFile="~/kys.master" AutoEventWireup="true" CodeFile="student_update_info.aspx.cs" Inherits="student_update_info" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="jumbotron text-center page-header">
            <p class="student-name-text">Student Information Update </p>
            <hr />
        </div>
    </div>
    <div class="container">
