<%@ Page Title="" Language="C#" MasterPageFile="~/kys.master" AutoEventWireup="true" CodeFile="placement_student_info.aspx.cs" Inherits="placement_student_info" %>
    ...
    <div class="container">
        <div class="jumbotron col-md-12 ">
            <div class="text-center page-header">
                <p class="student-name-text">Student Detail for Volunteer / Coordinator</p>
            </div>
            <form id="form1" runat="server" class="form-group text-center">
                <div class="col-md-12">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:kysdatabase %>" SelectCommand="SELECT [st_name], [st_regid], [st_mobile], [st_hostel], [st_hobbies], [st_college_aggre], [st_attendance] FROM [student_info_new] WHERE ([st_name] = @st_name) OR ([st_regid] = @st_regid)">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="st_name" QueryStringField="data" Type="String" />
                            <asp:QueryStringParameter Name="st_regid" QueryStringField="data" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <div class="col-md-12">
                        <br />
